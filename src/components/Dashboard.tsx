...
import { Package, Inbox, AlertTriangle, XCircle, ArrowUpRight, ArrowDownRight, RefreshCcw, Bell } from 'lucide-react';
...
export default function Dashboard({ products, transactions, onNavigateToTab, onSelectProductForIntake }: DashboardProps) {
  // คำนวณสถิติ
